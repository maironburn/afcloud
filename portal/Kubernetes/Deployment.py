...
class Deployment(object):
    ...
    all_attr        = [
                        'deployment_name','image','name','app',
                        'config_file','replicas', 'c_port','namespace'
                      ]
    ...
    def __init__(self,**kwargs):
        ...
        self.logger.error("Iniciando configuracion de kubernates usando fichero: %s" % (self.config_file))
    ...
    def create_deployment(self, namespace="default"):
        ...
        try:
            ...
            self._get_api_instance('ExtensionsV1beta1Api')
            self.namespace= self.namespace if self.namespace else namespace
            ...
            self.logger.error ("Exception en la creacion del deployment: %s" % format(ex))
    ...
    def _get_api_instance(self,api_instance):
    ...
    def getNamespacedDeployment(self, deployment_name=None, namespace=None, replicas=0):
